...
int ImpInterpreter::visit(DoWhileStatement* v)
{
  v->body->accept(this); //do
  while (v->cond->accept(this))
    v->body->accept(this); //while
  return 0;
}

int ImpInterpreter::visit(LoopSkipStatement* v)
{
  return 0;
}
